...
output "external_ip_address_gitlab_bysart_ru" {
  value = "${yandex_compute_instance.mashine[4].network_interface.0.nat_ip_address}"
}

output "internal_ip_address_runner_bysart_ru" {
...
output "external_ip_address_monitoring_bysart_ru" {
