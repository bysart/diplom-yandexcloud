...
Для установки данных сервисов, были использованы готовые роли, разработанные geerlingguy, riemers. Опасность использования готовых ролей понятна, однако во первых использовал из для того, чтобы показать и другой способ получения результата, во вторых получен опыт чтение ролей других разработчиков.
